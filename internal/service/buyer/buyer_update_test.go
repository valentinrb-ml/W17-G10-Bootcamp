...
func TestBuyerService_Update(t *testing.T) {
	...
	t.Run("should update buyer successfully with all fields", func(t *testing.T) {
		// Arrange
	...
	t.Run("should update buyer successfully with partial fields", func(t *testing.T) {
		// Arrange
		mockRepo := &mocks.BuyerRepositoryMocks{}
		buyerService := service.NewBuyerService(mockRepo)
	...
	t.Run("should return conflict error when card number already exists for another buyer", func(t *testing.T) {
		// Arrange
		mockRepo := &mocks.BuyerRepositoryMocks{}
		buyerService := service.NewBuyerService(mockRepo)
	...
	t.Run("should return error when buyer not found", func(t *testing.T) {
		// Arrange
		mockRepo := &mocks.BuyerRepositoryMocks{}
		buyerService := service.NewBuyerService(mockRepo)
	...
	t.Run("should update buyer without card number validation when card number is not provided", func(t *testing.T) {
		// Arrange
		mockRepo := &mocks.BuyerRepositoryMocks{}
		buyerService := service.NewBuyerService(mockRepo)
	...
	t.Run("should handle empty request gracefully", func(t *testing.T) {
		// Arrange
		mockRepo := &mocks.BuyerRepositoryMocks{}
		buyerService := service.NewBuyerService(mockRepo)
