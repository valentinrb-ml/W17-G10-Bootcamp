...
func TestBuyerService_FindAll(t *testing.T) {
	...
	t.Run("should find all buyers successfully", func(t *testing.T) {
		// Arrange
	...
	t.Run("should return empty slice when no buyers found", func(t *testing.T) {
		// Arrange
		mockRepo := &mocks.BuyerRepositoryMocks{}
		buyerService := service.NewBuyerService(mockRepo)
	...
	t.Run("should handle single buyer correctly", func(t *testing.T) {
		// Arrange
		mockRepo := &mocks.BuyerRepositoryMocks{}
		buyerService := service.NewBuyerService(mockRepo)
	...
	t.Run("should sort buyers by ID correctly", func(t *testing.T) {
		// Arrange
		mockRepo := &mocks.BuyerRepositoryMocks{}
		buyerService := service.NewBuyerService(mockRepo)
	...
	t.Run("should handle buyers with duplicate IDs", func(t *testing.T) {
		// Arrange
		mockRepo := &mocks.BuyerRepositoryMocks{}
		buyerService := service.NewBuyerService(mockRepo)
