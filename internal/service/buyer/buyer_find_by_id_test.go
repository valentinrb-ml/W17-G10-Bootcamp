...
func TestBuyerService_FindById(t *testing.T) {
	...
	t.Run("should find buyer by ID successfully", func(t *testing.T) {
		// Arrange
	...
	t.Run("should find buyer with all fields populated", func(t *testing.T) {
		// Arrange
		mockRepo := &mocks.BuyerRepositoryMocks{}
		buyerService := service.NewBuyerService(mockRepo)
	...
	t.Run("should panic when repository returns nil buyer without error", func(t *testing.T) {
		// Arrange
		mockRepo := &mocks.BuyerRepositoryMocks{}
		buyerService := service.NewBuyerService(mockRepo)
	...
	t.Run("should find multiple different buyers by different IDs", func(t *testing.T) {
		// Arrange
		mockRepo := &mocks.BuyerRepositoryMocks{}
		buyerService := service.NewBuyerService(mockRepo)
